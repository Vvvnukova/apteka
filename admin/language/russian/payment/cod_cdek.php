...
// Text
$_['text_edit']				= 'Редактировать способ оплаты';
...
// Help
$_['help_cache_on_delivery']		= 'Только если выбран способ доставки СДЭК';
$_['help_min_total']		= 'Ниже этого значения оплата не выводится. Оставить поле пустым, чтобы не учитывать';
$_['help_max_total']		= 'Выше этого значения оплата не выводится. Оставить поле пустым, чтобы не учитывать';
$_['help_city_ignore']		= 'Значения вписываются через запятую';
