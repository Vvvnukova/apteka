...
$_['text_view_type_attention']          = '<strong>ВНИМАНИЕ!</strong> Функция будет работать только при выполнении инструкции из файла <u>readme.txt</u>.';
$_['text_from']							= 'от';
...
$_['entry_use_region']					= 'Запретить учет региона для выбранных стран';
$_['entry_check_ip']			        = 'Определять города по IP';
...
$_['entry_pvz_ignore']					= 'Список ПВЗ для которых выводить модуль не нужно';
$_['entry_empty']						= 'Выводить всегда';
$_['entry_empty_cost']					= 'Стоимость';
$_['entry_more_days']					= 'Увеличить срок доставки';
$_['entry_insurance']                   = 'Учитывать страховку';
...
// Help
$_['help_log']							= 'Все ошибки в работе модуля или расчета доставки будут записаны в лог <br />(Система → Журнал ошибок).';
$_['help_packing_additional_weight']	= 'Значение будет добавлен к суммарному весу заказа';
$_['help_column_total']					= 'Сумма, начиная с которой правило действительно';
$_['help_empty_address']				= 'Показывать модуль если пользователь не заполнил адрес';
$_['help_min_weight']					= 'Значение указывается в килограммах';
$_['help_max_weight']					= 'Значение указывается в килограммах';
$_['help_min_total']					= 'Ниже этого значения доставка не выводится. Оставить поле пустым, чтобы не учитывать';
$_['help_max_total']					= 'Выше этого значения доставка не выводится. Оставить поле пустым, чтобы не учитывать';
$_['help_length_class']					= 'Единица измерения длины для сантиметров';
$_['help_weight_class']					= 'Единица измерения веса для килограммов';
$_['help_city_from']					= 'Автокомплит';
$_['help_use_region']					= 'Если название ригиона, области, штата, провинции и т.д. не совпадает с таковым в базе СДЭК, то доставка не будет расчитана. Если регион не учитывается, то точность определения снижается.';
$_['help_size']							= 'Указывается в сантиметрах';
$_['help_work_mode']					= 'Вывод результатов формируется на основании списка выбранных тарифов';
$_['help_show_pvz']						= 'Только для режимов доставки дверь-склад и склад-склад';
$_['help_pvz_more_one']					= 'Действие в случае если в городе-получателе есть несколько ПВЗ';
$_['help_column_title']					= 'Будет использовано вместо названия метода';
$_['help_column_geo_zone']				= 'Если географическая зона не выбрана<br /> тариф будет доступен для всех регионов';
$_['help_city_ignore']					= 'Значения вписываются через запятую';
$_['help_pvz_ignore']					= 'Значения вписываются через запятую';
$_['help_discount_column_geo_zone']		= 'Если географическая зона не выбрана<br /> правило будет применено для всех регионов';
$_['help_empty_cost']					= 'По умолчанию: 0';
$_['help_check_ip']					    = 'Будет использовано в случае если иначе определить город не удалось';
$_['help_insurance']                    = '0,75 % от стоимости товаров';
...
$_['error_curl']						= 'Для работы модуля трубуется PHP-расширение CURL!';
$_['error_simple_xml']					= 'Для работы модуля трубуется PHP-расширение SimpleXML!';
$_['error_mbstring']					= 'Для работы модуля трубуется PHP-расширение Mbstring!';
